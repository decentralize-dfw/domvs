...
export class HotspotManager {
    ...
    update(delta) {
        ...
        // Cursor style
        this.renderer.domElement.classList.toggle('vea-hovering', anyHovered);
    }
    ...
    _setupEvents() {
        ...
        this.renderer.domElement.addEventListener('pointermove', e => {
            ...
            for (const o of this.objects) {
                ...
                if (o.sprite) { targets.push(o.sprite); targetMap.set(o.sprite, o); }
                o.group.traverse(c => {
                    if (c.isMesh && c.userData.isHotspotSprite) { targets.push(c); targetMap.set(c, o); }
                });
            }
            const hits = this.raycaster.intersectObjects(targets, false);
            const hoveredObj = hits.length > 0 ? targetMap.get(hits[0].object) : null;
            for (const o of this.objects) o.hovered = (o === hoveredObj);
        });
...
export class CameraEditor {
    ...
    _setupDOM() {
        ...
        // All CSS moved to demo4-style.css
    }
